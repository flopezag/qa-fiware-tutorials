...
Scenario: 01 - Request options of endpoint 'entities'
  When  I set the url to "http://localhost:1026/ngsi-ld/v1/entities"
  And   I send an OPTIONS HTTP request to that url
  Then  I receive a HTTP "200" response code
  And   Header contains key "Allow" with value "GET,POST,OPTIONS"

#Scenario: 02 - Request options of endpoint 'entities/<entity_id>'
#  When  I set the url to "http://localhost:1026/ngsi-ld/v1/entities/urn:ngsi-ld:City:001"
#  And   I send an OPTIONS HTTP request to that url
#  Then  I receive a HTTP "200" response code
#  And   Header contains key "Allow" with value "application/json, application/ld+json, application/merge-patch+json"
#  And   Header contains key "Accept-Patch" with value "GET,PUT,DELETE,PATCH,OPTIONS"
