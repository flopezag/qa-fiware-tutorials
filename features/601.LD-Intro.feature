Feature: test tutorial 601 Introduction to Linked Data
...
#
#   Request 0
#       Note: The expected body in the Tutorial has older values with respect to the current orionld version.
#             Besides, the expected answer is structured while the current answer is not.
#
    Scenario: [1] Checking the Orion service health
...
#           - in the file "response601_06" the first entity is as provided by orionld while the second entity
...
#
    Scenario: [6] OBTAIN ENTITY DATA BY TYPE
      ...
      And   With header "Link": "<https://smartdatamodels.org/context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
...
#           - the attribute "@context" is at the beginning of the entity and not at the end as expected
#           - the attribute "category" is of a wrong type and misplaced.
#           The file "response601_07" is updated as provided by orionld to let understand how to correct the tutorial.
#
