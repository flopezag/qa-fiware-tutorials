Feature: test tutorial 304.Time-Series Data with QuantumLeap
  ...
  Scenario: 03 - Checking Subscription for QuantumLeap
    ...
    Then   I receive a HTTP "200" response code with the body "response304-03.json" and exclusions "response304-03.excludes"
  ...
  Scenario: Get QuantumLeap version data
    ...
    Then  I receive a HTTP "200" response code with the body "response304-version.json"
