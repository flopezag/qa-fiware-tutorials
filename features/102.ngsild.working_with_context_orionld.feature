...
# that the necessary prerequisites are in place.
  ...
  Scenario: 04 - Obtaining Entity data by FQN Type
    ...
    And   I perform the query request
    Then  I receive a HTTP "200" status code from Orion-LD with the body "102.ld.04.response.json" and exclusions "response102-04.excludes"
  ...
  Scenario: 05 - Obtaining Entity data by ID
    ...
    And   I set header Link to <http://context/ngsi-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json"
    And   I perform the query request
    Then  I receive a HTTP "200" status code from Orion-LD with the body "102.ld.05.response.json" and exclusions "response102-05.excludes"
  ...
  Scenario Outline: 06-12 - Several queries
    ...
    And   I perform the query request
    Then  I receive a HTTP "200" status code from Orion-LD with the body "<body_response>" and exclusions "<excludes_file>"
    Examples:
