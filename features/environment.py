...
def is_interesting_feature_string(feature_description: str):
    return any(
        feature_description.startswith(f"{f}:") for f in INTERESTING_FEATURES_STRINGS
    )
...
def before_feature(context, feature):
    ...
    if "shell-commands" in parameters:
        ...
        context.broker, context.core_context = get_broker_name_and_context(
