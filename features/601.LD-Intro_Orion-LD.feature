...
#
#   Request 0
#       Note: The expected body in the Tutorial has older values with respect to the current orion-ld version.
...
#           - in the file "response601_06" the first entity is as provided by orion-ld while the second entity
...
#
    Scenario: [6] OBTAIN ENTITY DATA BY TYPE
      ...
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-06.json"
...
#           - the attribute "@context" is at the beginning of the entity and not at the end as expected
#           - the attribute "category" is of a wrong type and misplaced.
#           The file "response601_07" is updated as provided by orion-ld to let understand how to correct the tutorial.
#
    Scenario: [7] FILTER CONTEXT DATA BY COMPARING THE VALUES OF AN ATTRIBUTE
      ...
      And    I set a parameter with the value equal to "options=keyValues"
      And    I send a GET HTTP request to that url
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-07.json"
...
#
    Scenario: [8] FILTER CONTEXT DATA BY COMPARING THE VALUES OF AN ATTRIBUTE IN AN ARRAY
      ...
      And    I set a parameter with the value equal to "options=keyValues"
      And    I send a GET HTTP request to that url
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-08.json"
...
#
    Scenario: [9] FILTER CONTEXT DATA BY COMPARING THE VALUES OF A SUB-ATTRIBUTE
      ...
      And    I set a parameter with the value equal to "options=keyValues"
      And    I send a GET HTTP request to that url
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-09.json"
...
#
    Scenario: [10] FILTER CONTEXT DATA BY QUERYING METADATA
      ...
      And    I set a parameter with the value equal to "options=keyValues"
      And    I send a GET HTTP request to that url
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-10.json"
...
#
    Scenario: [11] FILTER CONTEXT DATA BY COMPARING THE VALUES OF A GEO:JSON ATTRIBUTE
      ...
      And    I set a parameter with the value equal to "options=keyValues"
      And    I send a GET HTTP request to that url
      Then   I receive a HTTP "200" response code from Orion-LD with the body equal to "response601-11.json"
