Feature: test tutorial 602 Linked Data: Relationships and Data Models
...
#   Overal Note: The tutorial does not say anything aout the response code expected.
...
#
#   Request 1
#       Note: The expected body in the Tutorial has the following differences with respect to the current orionld version:
...
#
    Scenario: [1] DISPLAY ALL entities of a given type (BUILDINGS)
      ...
      And   With headers "NA$NA"
      And   With parameters "type$https://uri.fiware.org/ns/data-models#Building$options$keyValues"
      Then  I receive from orionld "200" response code with the body equal to "response602-01.json"
...
#
    Scenario: [2] DISPLAY ALL entities of a given type (PRODUCT)
      When  I send GET HTTP request to orionld at "http://localhost:1026/ngsi-ld/v1/entities"
      And   With headers "Link$<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
      And   With parameters "type$https://fiware.github.io/tutorials.Step-by-Step/schema/Product$options$keyValues"
      Then  I receive from orionld "200" response code with the body equal to "response602-02.json"
...
#
    Scenario: [3] DISPLAY ALL entities of a given type (SHELF)
      ...
      Then  I receive from orionld "200" response code with the body equal to "response602-03.json"
...
#
    Scenario: [4] OBTAIN SHELF INFORMATION
      When  I send GET HTTP request to orionld at "http://localhost:1026/ngsi-ld/v1/entities/urn:ngsi-ld:Shelf:unit001/"
      And   With headers "Link$<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
      And   With parameters "options$keyValues"
      Then  I receive from orionld "200" response code with the body equal to "response602-04.json"
...
#
    Scenario: [7] FIND THE STORE IN WHICH A SPECIFIC SHELF IS LOCATED
      ...
      Then  I receive from orionld "200" response code with the body equal to "response602-07.json"
...
#
    Scenario: [8] FIND THE IDS OF ALL SHELF UNITS IN A STORE
      When  I send GET HTTP request to orionld at "http://localhost:1026/ngsi-ld/v1/entities/"
      And   With headers "Accept$application/json$Link$<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
      And   With parameters "type$Shelf$options$keyValues$attrs$locatedIn"
      Then  I receive from orionld "200" response code with the body equal to "response602-08.json"
...
#
    Scenario: [10] FINDING ALL SHELF UNITS FOUND WITHIN A STORE
      When  I send GET HTTP request to orionld at "http://localhost:1026/ngsi-ld/v1/entities/urn:ngsi-ld:Building:store001"
      And   With headers "Accept$application/json$Link$<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
      And   With parameters "options$keyValues$attrs$furniture"
      Then  I receive from orionld "200" response code with the body equal to "response602-10.json"
...
#
    Scenario: [12] FINDING ALL SHELF UNITS FOUND WITHIN A STORE
      ...
      Then  I receive from orionld "200" response code with the body equal to "response602-12.json"
...
#
    Scenario: [13] FIND ALL PRODUCTS SOLD IN A STORE
      ...
      Then  I receive from orionld "200" response code with the body equal to "response602-13.json"
...
#
    Scenario: [14] OBTAIN STOCK ORDER
      When  I send GET HTTP request to orionld at "http://localhost:1026/ngsi-ld/v1/entities/urn:ngsi-ld:StockOrder:001"
      And   With headers "NA$NA""
      And   With parameters "options$keyValues"
      Then  I receive from orionld "200" response code with the body equal to "response602-14.json"
