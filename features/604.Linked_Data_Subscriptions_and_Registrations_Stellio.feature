Feature: Test tutorial 604.Linked_Data_Subscriptions_and_Registrations (Stellio)
  ...
  Scenario: 01 - Create a subscription (Store 1) - Low stock
    ...
    And    I set the url to "http://localhost:8080/ngsi-ld/v1/subscriptions/"
  ...
  Scenario: 03 - Read subscription details
    When   I set the url to "http://localhost:8080/ngsi-ld/v1/subscriptions/"
  ...
  Scenario: 04 - Create a registration
    ...
    And    I set the url to "http://localhost:8080/ngsi-ld/v1/csourceRegistrations/"
  ...
  Scenario: 09 - Request the registered attribute
    When   I set the url to "http://localhost:8080/ngsi-ld/v1/entities/urn:ngsi-ld:Building:store001?attrs=tweets&options=keyValues"
    And    I set the "Link" header with the value "<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json"
    And    I send a GET HTTP request to that url
  ...
  Scenario: 10 - Forwarded update
    When   I set the "Content-Type" header with the value "application/json"
    And    I set the "Link" header with the value "<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
    And    I set the url to "http://localhost:8080/ngsi-ld/v1/entities/urn:ngsi-ld:Building:store001/attrs/tweets"
  ...
  Scenario: 11 - Request the previous forwarded update
    When   I set the "Content-Type" header with the value "application/json"
    And    I set the url to "http://localhost:8080/ngsi-ld/v1/entities/urn:ngsi-ld:Building:store001?attrs=tweets&options=keyValues"
    And    I set the "Link" header with the value "<https://fiware.github.io/tutorials.Step-by-Step/tutorials-context.jsonld>; rel="http://www.w3.org/ns/json-ld#context"; type="application/ld+json""
    And    I send a GET HTTP request to that url
