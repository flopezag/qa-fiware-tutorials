Feature: Test tutorial 603.Traversing_Linked_Data (Scorpio)
  ...
  Scenario: 02 - Access the furniture attribute of a known Building entity
    ...
    And    I send a GET HTTP request to that url
    Then   I receive a HTTP "200" response code from Scorpio with the body equal to "response603-02.json"
  ...
  Scenario: 03 - Retrieve stocked products from shelves
    ...
    And    I send a GET HTTP request to that url
    Then   I receive a HTTP "200" response code from Scorpio with the body equal to "response603-03.json"
  ...
  Scenario: 04 - Retrieve product details for selected shelves
    ...
    And    I send a GET HTTP request to that url
    Then   I receive a HTTP "200" response code from Scorpio with the body equal to "response603-04.json"
  ...
  Scenario: 05 - Find a shelf stocking a product
    ...
    And    I send a GET HTTP request to that url
    Then   I receive a HTTP "200" response code from Scorpio with the body equal to "response603-05.json"
  ...
  Scenario: 10 - 04 Applying entity expansion/compaction
    ...
    And    I send a GET HTTP request to that url
    Then   I receive a HTTP "200" response code from Scorpio with the body equal to "response603-10.json"
