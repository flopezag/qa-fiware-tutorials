Feature: Test tutorial 406.Administrating_XACML_Rules
  ...
  Scenario: 05 - Request to access to loading in the white zone
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-05.xml"
  ...
  Scenario: 06 - Request to access to loading in the red zone
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-06.xml"
  ...
  Scenario: 07 - Updating a policy set
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-07.xml"
  ...
  Scenario: 08 - Activating an updated policy set
    ...
    And   I send a PUT HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-08.xml"
  ...
  Scenario: 09 - Request to access to loading in the white zone again
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-09.xml"
  ...
  Scenario: 10 - Request to access to loading in the red zone again
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-10.xml"
  ...
  Scenario: 12 - Read a Verb-resource permission
    ...
    Then   I receive a HTTP "200" response code from Keystone with the body "response406-12.json"
...
curl -X POST \
  ...
  Scenario: 18 - Permit access to a resource
    ...
    And   I send a POST HTTP request to that url
    Then  I receive a HTTP "200" response code from AuthZForce with the body "response406-18.xml"
